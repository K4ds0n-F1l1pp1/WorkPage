...
<head>
    ...
    <link rel="stylesheet" href="Styles/estilo_Index.scss">
...
<body class="text-dark m-5" style="  background-color: #92a8d1;">
    <container>
        ...
        <br>
        <nav class="rounded navbar navbar-dark border border-3 border-light" style="background-color:black; border-radius: 16px;">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="drivers.php" class="btn btn-primary">Ir para Gerenciamento de Motoristas</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="vehicles.php" class="btn btn-primary">Ir para Gerenciamento de Veículos</a>
                            </div>
                        </div>
                    </div>
        </container>
